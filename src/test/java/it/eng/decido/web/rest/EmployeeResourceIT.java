...
import it.eng.decido.repository.EmployeeRepository;
...
public class EmployeeResourceIT {
    ...
    public void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getDocument()).isEqualTo(DEFAULT_DOCUMENT);
        assertThat(testEmployee.getDocumentContentType()).isEqualTo(DEFAULT_DOCUMENT_CONTENT_TYPE);
    }
    ...
    public void updateEmployee() throws Exception {
        ...
        assertThat(testEmployee.getDocument()).isEqualTo(UPDATED_DOCUMENT);
        assertThat(testEmployee.getDocumentContentType()).isEqualTo(UPDATED_DOCUMENT_CONTENT_TYPE);
    }
