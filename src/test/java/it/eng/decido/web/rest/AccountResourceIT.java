...
import static it.eng.decido.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import it.eng.decido.TurinApp;
import it.eng.decido.config.Constants;
...
@SpringBootTest(classes = TurinApp.class)
