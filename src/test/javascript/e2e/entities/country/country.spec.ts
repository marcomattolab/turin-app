...
describe('Country e2e test', () => {
  ...
  it('should load Countries', async () => {
    ...
    expect(await countryComponentsPage.getTitle()).to.eq('turinApp.country.home.title');
  ...
  it('should load create Country page', async () => {
    ...
    expect(await countryUpdatePage.getPageTitle()).to.eq('turinApp.country.home.createOrEditLabel');
  ...
  it('should delete last Country', async () => {
    ...
    expect(await countryDeleteDialog.getDialogTitle()).to.eq('turinApp.country.delete.question');
