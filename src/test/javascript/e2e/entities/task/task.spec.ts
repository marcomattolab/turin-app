...
describe('Task e2e test', () => {
  ...
  it('should load Tasks', async () => {
    ...
    expect(await taskComponentsPage.getTitle()).to.eq('turinApp.task.home.title');
  ...
  it('should load create Task page', async () => {
    ...
    expect(await taskUpdatePage.getPageTitle()).to.eq('turinApp.task.home.createOrEditLabel');
  ...
  it('should delete last Task', async () => {
    ...
    expect(await taskDeleteDialog.getDialogTitle()).to.eq('turinApp.task.delete.question');
