...
import it.eng.decido.domain.Job;
import it.eng.decido.repository.JobRepository;
...
/**
 * REST controller for managing {@link it.eng.decido.domain.Job}.
 */
@RestController
@RequestMapping("/api")
public class JobResource {
    ...
    public ResponseEntity<Job> updateJob(@RequestBody Job job) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, job.getId()))
            .body(result);
    }
